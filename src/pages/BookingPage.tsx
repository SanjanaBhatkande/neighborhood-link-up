...
const BookingPage = () => {
  ...
  const handleConfirm = () => {
    ...
    if (!selectedDate || !selectedSlot)
      return alert("Please select both a date and time slot.");
    ...
    notifications.push({
      ...
      message: `Your booking with ${booking.provider} for ${booking.service} on ${booking.date} (${booking.slot}) is confirmed.`,
